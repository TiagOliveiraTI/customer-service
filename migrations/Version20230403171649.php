 ...
 */
final class Version20230403171649 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE customer (id UUID NOT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, state VARCHAR(2) NOT NULL, zipcode VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN customer.id IS \'(DC2Type:uuid)\'');
        $this->addSql('CREATE TABLE "order" (id UUID NOT NULL, customer_id UUID DEFAULT NULL, status VARCHAR(255) NOT NULL, discount DOUBLE PRECISION NOT NULL, total INT NOT NULL, order_date DATE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE product (id UUID NOT NULL, order_item_id UUID DEFAULT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
